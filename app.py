...
lineaccesstoken = 'Ne8rcQ4SY1gR2DOJhwD0qfjeEwy09wzMhqNjPI8YzQeXx7Gi0zEoj+Fv1JavZms9k5G7AVXQIdLGiRl5GNydILmw4uf+7NzD411DguzjknxoTgDA4McLa6MqNUgvi8n5t3bjk2DsNtUPhcQyj8oLYwdB04t89/1O/w1cDnyilFU='
...
def event_handle(event,json_line):
    ...
    if msgType == "text":
        ...
        if (msg == "สวัสดี") :
            ...
            line_bot_api.reply_message(rtoken, replyObj)
        elif (msg == "เธอชื่ออะไร") :
            replyObj = TextSendMessage(text="เราชื่อ ป๋องแป๋ง")
            line_bot_api.reply_message(rtoken, replyObj)
        elif (msg == "ทำไรอยู่") :
            replyObj = TextSendMessage(text="ฟังเพลงค่าา")
            line_bot_api.reply_message(rtoken, replyObj)
        else :
            headers = request.headers
            json_headers = ({k:v for k, v in headers.items()})
            json_headers.update({'Host':'bots.dialogflow.com'})
            url = "https://dialogflow.cloud.google.com/v1/integrations/line/webhook/68099b3b-a47c-46d6-b313-1962bcdbf2d5"
